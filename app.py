...
PRIVATE_API_KEY = st.secrets.get("API_KEY", "sk-Oc8p5YmZpACTrNK_ezzgno-Og8AeSYDUdQF6DdV9VZgRp9O0mKP3kZDGr3M")
PRIVATE_API_BASE = st.secrets.get("API_BASE", "https://hk.uniapi.io/v1")

# 2. 时效控制：设置二维码/网页的过期时间（示例设置为 2026 年 6 月 30 日）
EXPIRE_DATE = datetime.date(2026, 6, 30)
